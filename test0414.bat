@echo off
@REM author：zhangran
@REM describe：动态传参，替换jmx环境变量部分参数
chcp 65001
...
echo Replacing %paramName% in "%inputFile%" with new value "!newValue!"
powershell -NoProfile -ExecutionPolicy Bypass -File "zd0414.ps1" -inputFile "%inputFile%" -paramName "%paramName%" -newValue "!newValue!"
